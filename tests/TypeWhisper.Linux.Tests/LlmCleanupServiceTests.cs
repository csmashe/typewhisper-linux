...
public sealed class LlmCleanupServiceTests
{
    ...
    public async Task CleanAsync_Medium_UsesConfiguredLlmPrompt()
    {
        ...
        Assert.Equal(PromptProcessingService.FrameInputAsData("Hello"), provider.LastUserText);
    }
    ...
    public async Task CleanAsync_High_UsesConfiguredLlmPrompt()
    {
        ...
        Assert.Equal(PromptProcessingService.FrameInputAsData("Hello there"), provider.LastUserText);
    }

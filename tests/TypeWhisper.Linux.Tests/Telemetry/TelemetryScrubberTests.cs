...
public sealed class TelemetryScrubberTests
{
    ...
    [InlineData("fe80::1", "<ip>")]
    [InlineData("2001:db8:85a3::8a2e:370:7334", "<ip>")]
    [InlineData("2001:0db8:0000:0000:0000:ff00:0042:8329", "<ip>")]
    [InlineData("::ffff:192.168.0.1", "<ip>")]
    [InlineData("[fe80::1]:11434", "[<ip>]:11434")]
    [InlineData("12:34:56", "12:34:56")]
    [InlineData("2026-09-12T12:34:56", "2026-09-12T12:34:56")]
    [InlineData("Module::Type", "Module::Type")]
    [InlineData("Sentry::Foo", "Sentry::Foo")]

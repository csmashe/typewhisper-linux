...
/// </summary>
/// <param name="Success">
///     True on success (or no-op removal); false if the user
///     needs to fix something (mismatched sentinels, missing binary, etc.).
/// </param>
...
/// <param name="Warning">
///     Optional non-fatal warning — e.g. "wrote config but hyprctl was unavailable, restart Hyprland to
///     pick it up". Distinguished from <paramref name="UserMessage" /> so the UI can paint it differently.
/// </param>

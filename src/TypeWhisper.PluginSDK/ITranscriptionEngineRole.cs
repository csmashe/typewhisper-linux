...
/// <summary>
///     Non-owning role that provides audio transcription capabilities via a cloud or
///     local engine. The owner is responsible for this role's lifetime; hosts consume
///     only the capability surface exposed here.
/// </summary>
/// <remarks>
...
public interface ITranscriptionEngineRole
{
    /// <summary>
    ///     Identifier of the owning plugin. Additional roles use their selection identity
    ///     to distinguish selectable engines while retaining the owner's plugin ID.
    /// </summary>
    string PluginId { get; }

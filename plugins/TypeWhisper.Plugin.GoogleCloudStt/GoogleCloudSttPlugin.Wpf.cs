...
public sealed partial class GoogleCloudSttPlugin : IWpfPluginSettingsProvider
{
    public UserControl? CreateSettingsView()
    {
        var panel = new StackPanel { Margin = new Thickness(8) };
        var label = new TextBlock { Text = "Google Cloud API Key", Margin = new Thickness(0, 0, 0, 4) };
